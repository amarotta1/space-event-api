...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPACESHIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPACESHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPACESHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPACESHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPACESHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPACESHIP actions', async () => {
      const expectedActions = [
        {
