...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPACEEVENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPACEEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPACEEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPACEEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPACEEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPACEEVENT actions', async () => {
      const expectedActions = [
        {
