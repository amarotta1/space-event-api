...
export const ManufacturerUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="spaceApp.manufacturer.home.createOrEditLabel" data-cy="ManufacturerCreateUpdateHeading">
            <Translate contentKey="spaceApp.manufacturer.home.createOrEditLabel">Create or edit a Manufacturer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('spaceApp.manufacturer.name')}
